...
class InvoicePredictor:
    """Train and evaluate ML models for invoice payment delay prediction."""
    ...
    def train_models(self, df: pd.DataFrame):
        """
        Train classification and regression models for payment delay.

        Args:
            df (pd.DataFrame): Preprocessed invoice dataset

        Returns:
            tuple: (trained classifier, list of feature columns)
        """
        print("🤖 Training machine learning models...")

        # Exclude target and non-feature columns
        exclude_cols = [
            'DelayStatus', 'DelayDays', 'invoice_id', 'customer_id', 
        ...
        # Compute feature importance from classifier
        ...
        # Return classifier and feature columns for saving or later use
    ...
    def create_evaluation_plots(self):
        """Generate and save feature importance plot for top 10 features."""
